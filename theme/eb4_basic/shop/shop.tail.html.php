		...
		<div class="container">
			<div class="footer-top">
				<div class="footer-nav">
					<img src="<?php echo EYOOM_THEME_URL; ?>/image/logo-2.png" class="site-logo" alt="<?php echo $config['cf_title']; ?>">
				</div>
				<div class="footer-right-nav">
					<a href="<?php echo G5_BBS_URL; ?>/faq.php">채널추가</a>
					<a href="<?php echo G5_BBS_URL; ?>/faq.php">상품후기</a>
					<a href="<?php echo G5_BBS_URL; ?>/faq.php">상품후기</a>
			...
			<div class="footer-top-white-time">
				<span>
				CS CENTER 1522-2041
				</span>
			...
			<div class="footer-cont-info">
				...
				<?php } ?>
				<span class=""><?php echo $bizinfo['bi_company_name']; ?></span>
				<span class="info-divider">|</span>
			...
			<div class="footer-bottom-links">
				<a href="<?php echo G5_BBS_URL; ?>/faq.php">이용약관</a>
				<a href="<?php echo G5_BBS_URL; ?>/faq.php">개인정보처리방침</a>
				<a href="<?php echo G5_BBS_URL; ?>/faq.php">이메일무단수집거부</a>
			</div>
		</div>
	</footer>
	<?php /*----- footer 끝 -----*/ ?>
