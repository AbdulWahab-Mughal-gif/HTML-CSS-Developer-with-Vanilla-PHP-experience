        ...
        <div class="header-title">
            <div class="container">
                ...
                <?php } else if ($logo == 'image') { ?>
                    ...
                    <?php } else { ?>
                    <img src="<?php echo EYOOM_THEME_URL; ?>/image/logo.png" class="site-logo" alt="<?php echo $config['cf_title']; ?>">
                    <?php } ?>
                    <?php } else { ?>
                        ...
                        <div class="sidebar-left-content">
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="dropdown dropdown-mega-menu d-none d-lg-block">
                                    <a data-bs-toggle="dropdown" class="nav-link dropdown-toggle" href="#">전체상품</a>
